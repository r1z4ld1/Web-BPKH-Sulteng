        ...
        <div class="mx-auto max-w-4xl px-6 sm:px-8 lg:px-12">
            ...
            <div class="mb-8">
                <h2 class="text-2xl sm:text-3xl font-serif text-contrast mb-4 tracking-tight">
                    Pengaduan Masyarakat Tentang Kawasan Hutan Sulteng
                </h2>
                <p class="text-sm sm:text-base text-contrast/70 leading-relaxed max-w-3xl">
                Sampaikan pengaduan, keluhan, atau laporan terkait pelayanan Balai Pemantapan
                Kawasan Hutan Wilayah XVI Palu melalui formulir di bawah ini. Setiap pengaduan
                akan ditindaklanjuti sesuai prosedur yang berlaku.
                </p>
            </div>
