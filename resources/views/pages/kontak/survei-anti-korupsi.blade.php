        ...
        <div class="mx-auto max-w-4xl px-6 sm:px-8 lg:px-12">
            ...
            <div class="mb-8">
                ...
                <p class="text-sm sm:text-base text-contrast/70 leading-relaxed max-w-3xl">
                   Survei ini bertujuan mengukur persepsi masyarakat terhadap integritas dan upaya
                pencegahan korupsi di lingkungan Balai Pemantapan Kawasan Hutan Wilayah XVI Palu.
                Identitas dan jawaban Anda akan dijaga kerahasiaannya.
                </p>
            </div>
